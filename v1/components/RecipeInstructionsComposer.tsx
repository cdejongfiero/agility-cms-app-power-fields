...
const RecipeInstructionsComposer = ({ configuration }: { configuration: any }) => {
	...
	useEffect(() => {
		...
		try {
			...
			console.warn("Error parsing JSON for Recipe Instructions Composer", e)
		}
	}, [fieldValue, editor])
	...
	useEffect(() => {
		...
		const editorJS = new EditorJS({
			...
			tools: {
				// Only instructions block + basic text tools
...
export default RecipeInstructionsComposer
